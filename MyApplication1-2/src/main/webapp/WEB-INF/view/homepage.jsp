...
<body>
	...
	/*<div class="container text-centered">
		...
		<iframe width="400" height="200"
			src="https://www.youtube.com/embed/7L6vkXRUFWY" frameborder="0"
			allow="autoplay; encrypted-media" allowfullscreen></iframe>
			
			<p> This is 1st Session of the tutorial..... </p>
			<div class="alert alert-success">
			<h4>Session 1: Digital marketing Tutorial</h4>
		</div>
		<iframe width="400" height="200"
			src="https://www.youtube.com/embed/iosd3UeKdCs" frameborder="0"
			allow="autoplay; encrypted-media" allowfullscreen></iframe>
			
			<p> This is 1st Session of the tutorial..... </p>
			<div class="alert alert-success">
			<h4>Session 1: Digital Markrting Tutorial</h4>
		</div>
		<iframe width="400" height="200"
